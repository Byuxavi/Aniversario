...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function initDateChecker() {
     ...
     * Corregido para calcular exactamente los meses transcurridos
     */
    function updateMonthsCounter(anniversaryDate) {
        ...
        // Cálculo mejorado para contar meses exactos
        let months = (today.getFullYear() - start.getFullYear()) * 12 + 
                     (today.getMonth() - start.getMonth());
        
        // Ajuste por día del mes
        // Si el día actual es menor que el día del aniversario, restar un mes
